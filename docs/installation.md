...
| `faster-whisper` | Speech recognition for audio transcription and voice dictation of notes (the only speech-to-text backend; the legacy `openai-whisper`/PyTorch one was deprecated in 0.1.25 and removed in 0.2.0) | `pip install faster-whisper` |
